...
yazdır kullanicilar[0]["name"]
yazdır kullanicilar[0]["email"]

// Tüm isimleri listele
her kullanici icinde kullanicilar:
    yazdır kullanici["name"]
son
```
...
eger hava degildir hic:
    ...
    yazdır "Sıcaklık   :" simdiki["temperature"] "°C"
    yazdır "Rüzgar     :" simdiki["windspeed"] "km/s"
    yazdır "Hava kodu  :" simdiki["weathercode"]
degilse:
...
yazdır "İlk gönderi:" gonderiler[0]["title"]
yazdır
